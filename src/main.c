...
/*   Updated: 2016/12/08 21:32:18 by hhismans         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	data.color = 0xffffff;//1493;
	...
	data.type = PLANE;
	data.color = FOREST_GREEN;
	set_vector(&data.vector,0, 1, 0); // a,b,c
	data.data[0] = 5; // d
	data.data[1] = 1;
	pushback_obj(e->objs, data);

	data.color = ORANGE_RED;
